    ...
    <div className="px-8 py-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-stone-600 mt-1">등록된 admin {admins.length}명</p>
        </div>
        <button
      ...
      {loading ? (
        ...
        <p className="text-sm text-stone-500">등록된 admin X</p>
      ) : (
          ...
          <table className="w-full text-sm">
            <thead className="bg-stone-50 text-stone-600">
              <tr>
                ...
                <th className="text-left px-4 py-3 font-medium">등록 일자</th>
              </tr>
            </thead>
            <tbody>
              {admins.map(a => {
